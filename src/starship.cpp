...
void Starship::display()
{
    ...
    double px1, py1;
    transfo2D(tube->get_vertex(position), tube->get_vertex(position+1), 0, 0, px1, py1);

    double px2, py2;
    transfo2D(tube->get_vertex(position), tube->get_vertex(position+1), normAB, 0, px2, py2);
